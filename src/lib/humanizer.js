const AI_PHRASE_REPLACEMENTS = [
  ...
  { from: /tidak dapat dipungkiri/gi, to: "memang" },
  { from: /perlu diketahui bahwa/gi, to: "tahu nggak" },
  { from: /perlu dicatat bahwa/gi, to: "catat ya" },
  { from: /perlu diingat bahwa/gi, to: "inget ya" },
  { from: /sangat penting untuk/gi, to: "penting banget untuk" },
  { from: /dapat disimpulkan bahwa/gi, to: "simpelnya" },
  { from: /sebagaimana kita ketahui/gi, to: "seperti yang kita tau" },
  { from: /berdasarkan hasil analisis/gi, to: "setelah dianalisis" },
  { from: /berdasarkan hasil penelitian/gi, to: "menurut penelitian" },
  { from: /dengan kata lain/gi, to: "artinya" },
  { from: /hal ini disebabkan oleh/gi, to: "ini karena" },
  { from: /hal ini menunjukkan bahwa/gi, to: "ini nunjukkin bahwa" },
  { from: /hal ini mengindikasikan bahwa/gi, to: "ini nandain bahwa" },
  { from: /seperti yang telah disebutkan/gi, to: "seperti yang udah disebut" },
  { from: /seperti yang telah dijelaskan/gi, to: "seperti yang udah dijelasin" },
  { from: /pada era digital ini/gi, to: "jaman digital sekarang" },
  { from: /di era globalisasi/gi, to: "jaman globalisasi" },
  { from: /di era modern ini/gi, to: "jaman now" },
  { from: /pada zaman sekarang/gi, to: "sekarang" },
  { from: /di masa sekarang/gi, to: "sekarang ini" },
  { from: /dalam rangka/gi, to: "untuk" },
  { from: /dalam upaya/gi, to: "biar" },
  { from: /seiring dengan perkembangan/gi, to: "seiring berkembangnya" },
  { from: /seiring berjalannya waktu/gi, to: "lama-kelamaan" },
  { from: /pada dasarnya/gi, to: "pada dasarnya sih" },
  { from: /pada hakikatnya/gi, to: "sebetulnya" },
  { from: /pada intinya/gi, to: "intinya" },
  { from: /secara keseluruhan/gi, to: "semua" },
  { from: /merupakan salah satu/gi, to: "termasuk" },
  { from: /berbagai macam/gi, to: "macam-macam" },
  { from: /berbagai jenis/gi, to: "jenis-jenis" },
  { from: /oleh karena itu/gi, to: "makanya" },
  { from: /oleh sebab itu/gi, to: "makanya" },
  { from: /dengan demikian/gi, to: "jadi" },
  { from: /maka dari itu/gi, to: "jadi" },
  { from: /dari penjelasan di atas/gi, to: "dari penjelasan tadi" },
  { from: /berperan penting dalam/gi, to: "penting dalam" },
  { from: /memegang peranan penting/gi, to: "punya peran penting" },
  { from: /sangatlah penting/gi, to: "penting banget" },
  { from: /sangat diperlukan/gi, to: "diperlukan banget" },
  { from: /perlu adanya/gi, to: "perlu ada" },
];
