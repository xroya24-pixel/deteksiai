  ...
  return {
    ...
    details: {
      perplexity: {
        ...
        description: "Mengukur seberapa 'terprediksi' teks. AI cenderung menggunakan kata yang lebih umum dan mudah ditebak, menghasilkan perplexity rendah.",
      ...
      phraseDensity: {
        score: phraseScore,
        label: "Frasa AI",
        description: "Deteksi frasa klise yang sering muncul di tulisan AI seperti 'delve into', 'landscape', dll.",
      ...
      transitionScore: {
        ...
        label: "Kata Transisi",
        description: "Frekuensi kata transisi (however, therefore, moreover, dll). AI sering overuse.",
